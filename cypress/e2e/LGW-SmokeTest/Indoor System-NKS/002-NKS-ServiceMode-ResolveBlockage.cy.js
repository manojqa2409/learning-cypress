...
describe('ResolveBlockage-ServiceMode', () =>{
    ...
    it('TC-001-> WithAIV-> Operation(FireDamper/AIV/FractionSwitch/Aligned For Another Fraction)-> Back To Normal From Service Mode', {scrollBehavior: false}, () => {
        cy.visit('/');
    ...
    it('TC-002-> WithOUT AIV-> Operation(FireDamper/AIV/FractionSwitch/Aligned For Another Fraction)->Back To Normal From Service Mode', {scrollBehavior: false}, function() {
        cy.visit('/')
        cy.expandAccordionsGlobalToggleFlag();
